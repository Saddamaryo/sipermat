<!--TAMBAH DATA ARSIP SURAT MAHASISWA-->

<div class="modal fade" id="Tambaharsipsurat" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('tambaharsipsurat') }}" method="post" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="nomor_urut" value = "{{ $lastNomorUrut += 1 }}"
                            required>
                    </div>
                    <div class="mb-3">
...
@foreach ($pengarsipansurat as $item)
    <!-- Delete Modal -->
    <div class="modal fade" id="deletearsipsurat{{ $item->id }}" tabindex="-1" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('deletearsipsurat/'.$item->id)}}" method="post">
                        @method('DELETE')
                        @csrf
                        <div class="mb-3">
