                ...
                <div class="content">
                    <div id="alamat" class="row">
                        <div id="lampiran" class="col-md-6">
                            ...
                            @endif
                            Lampiran : - <br />
                            Perihal : Permohonan Surat Keterangan Mahasiswa
                            <br>
                            <br>
                        </div>
                        <div id="tgl-srt">
                    ...
                    <br>
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat keterangan mahasiswa aktif bagi mahasiswa di bawah ini: </div>
                    ...
                    <br>
                    <div id="penutup">Mahasiswa tersebut adalah mahasiswa Program Studi {{ $cekdata->prodi_mahasiswa }} FMIPA Universitas
                        Negeri Jakarta. Surat ini dibuat untuk {{ $cekdata->formulir1 }}.</div>
                    <br>
        ...
        @if (is_array($array_namamhs) && count($array_namamhs) >= 4 && is_array($array_nimmhs) && count($array_nimmhs) >= 4)
            ...
            <div class="sheet">
                ...
                <div class="content">
                    ...
                    <div id="pembuka">Dengan hormat,</div>
                    <br>
                    <div id="pembuka" class="row">Kami sampaikan permohonan untuk mendapatkan surat
                        keterangan mahasiswa aktif untuk mahasiswa daftar nama terlampir. </div>

                    <br>
                    <div id="penutup">Adalah mahasiswa Program Studi {{ $cekdata->prodi_mahasiswa }} FMIPA
                        Universitas
                        Negeri Jakarta. Surat ini dibuat untuk {{ $cekdata->formulir1 }}.</div>
                    <br>
