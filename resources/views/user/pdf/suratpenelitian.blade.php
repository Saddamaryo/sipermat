    ...
    <!--MAKSIMAL 3 MAHASISWA-->
        <div class="sheet">
                ...
                <table>
                    <tr>
                        ...
                        <td class="tengah">
                            ...
                            <h3 class="unj">UNIVERSITAS NEGERI JAKARTA</h3>
            ...
            <div class="content">
                ...
                <br>
                <div id="pembuka" class="row">Kami sampaikan permohonan surat pengantar melaksanakan penelitian untuk {{$cekdata->formulir4}} mahasiswa kami di bawah ini: </div>
                <div id="tempat-tgl">
                ...
                <div id="penutup">Demikian surat permohonan ini kami sampaikan. Atas perhatian dan kerja sama yang baik kami ucapkan terima kasih.</div>
                <br>
                <br>
                <br>
