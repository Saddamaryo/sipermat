            ...
            <div class="content">
                <div id="alamat" class="row">
                    <div id="lampiran" class="col-md-6">
                        ...
                        @endif
                        Lampiran : - <br />
                        Perihal : Permohonan Observasi Lapangan
                        <br>
                        <br>
                    </div>
                    <div id="tgl-srt">
                ...
                <br>
                <div id="pembuka" class="row">Kami mengajukan permohonan surat pengantar melaksanakan Observasi Lapangan untuk {{$cekdata->formulir4}} mahasiswa kami di bawah ini: </div>
                <br>
                <div id="tempat-tgl">
                ...
                <br>
                <div id="penutup">Demikian surat permohonan ini kami sampaikan. Atas perhatian dan kerja samanya, kami ucapkan terima kasih.</div>
                <br>
                <br>
                <br>
