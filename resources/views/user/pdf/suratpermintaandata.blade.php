...
@php
    $array_data = [];
    if ($cekdata->formulir4) {
        $array_data = explode(';', $cekdata->formulir4);
    }
@endphp
...
<body>
    ...
    @if (count($array_namamhs) != count($array_nimmhs))
        <h2 class="kementrian">Periksa input nim dan namanya</h2>
    @else
                ...
                <div class="content">
                    <div id="alamat" class="row">
                        <div id="lampiran" class="col-md-6">
                            ...
                            @endif
                            Lampiran : - <br />
                            Perihal : Permohonan Surat Pengantar Permintaan Data
                            <br>
                            <br>
                        </div>
                        <div id="tgl-srt">
                    ...
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat Pengantar Permintaan Data untuk keperluan {{ $cekdata->formulir5 }} untuk mahasiswa Program Studi
                        {{ $cekdata->prodi_mahasiswa }} di bawah ini:</div>
                    ...
                    <br>
                    <div id="penutup">Adapun data-data yang diperlukan adalah:</div>
                    <div id="penutup">
                        <table>
                    ...
                    <br>
                    <div id="penutup">Demikian permohonan ini kami sampaikan. Atas bantuan dan kerja samanya, kami ucapkan terima kasih.</div>
                    <br>
        ...
        @if (is_array($array_namamhs) && count($array_namamhs) >= 4 && is_array($array_nimmhs) && count($array_nimmhs) >= 4)
            ...
            <div class="sheet">
                ...
                <div class="content">
                    ...
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat pengantar permintaan data guna keperluan {{ $cekdata->formulir5 }} untuk mahasiswa Program Studi
                        {{ $cekdata->prodi_mahasiswa }} yang tersebut daftar nama terlampir.</div>
                    <div id="tempat-tgl">
                        <table>
                            <tr>
                                <td>Tempat</td>
                    ...
                    <div id="penutup">Demikian permohonan ini kami sampaikan. Atas bantuan dan kerjasamanya, kami
                        ucapkan
                        terima
                        kasih.</div>
                    <div id="ttd" class="row">
                    ...
                    <table style="margin-top:25px;page-break-inside: auto" class="kartu">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 7cm">Nama Mahasiswa </th>
                                <th>No. Reg </th>
                            </tr>
                        </thead>
                        <tbody>
