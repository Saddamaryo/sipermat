            ...
            <div class="sheet">
                <div class="kopsurat">
                    <table>
                        <tr>
                            <td>
                                <img src="{{ public_path('storage/image/logounj.png') }}" alt="" width="150px"
                                    height="160px">
                            </td>
                            <td class="tengah">
                ...
                <div class="content">
                    <div id="alamat" class="row">
                        <div id="lampiran" class="col-md-6">
                            ...
                            @endif
                            Lampiran : - <br />
                            Perihal : Permohonan Surat Pengantar PKL
                            <br>
                            <br>
                        </div>
                        <div id="tgl-srt">
                    ...
                    <br>
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat
                        pengantar Praktik Kerja Lapangan (PKL) bagi mahasiswa Program Studi
                    ...
                    <br>
                    <div id="penutup">Untuk mengadakan Praktik Kerja Lapangan pada bulan {{ $cekdata->formulir3 }}.
                    </div>
                    <br>
                    <div id="penutup">Demikian permohonan ini kami sampaikan. Atas bantuan dan kerjas amanya, kami
                        ucapkan
                        terima
                        kasih.</div>
                    <br>
        ...
        @if (is_array($array_namamhs) && count($array_namamhs) >= 4 && is_array($array_nimmhs) && count($array_nimmhs) >= 4)
            ...
            <div class="sheet">
                ...
                <div class="content">
                    ...
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat
                        pengantar Praktik Kerja Lapangan (PKL) bagi mahasiswa Program Studi
                        {{ $cekdata->prodi_mahasiswa }} dengan daftar nama terlampir.</div>
                    <div id="tempat-tgl">
                        <br>
                        <table>
                            <tr>
            ...
            <div class="sheet">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="tengah">
                                ...
                                <b class="kampus">
                                    <br>
                                    Telepon (021) 4894909, E-mail : <a href="">dekanfmipa@unj.ac.id</a>, <a href="">www.fmipa.unj.ac.id</a>
                                </b>
                                <br>
                            </td>
                        </tr>
                ...
                <div class="content">
                    ...
                    <div id="penutup"><strong>
                            <p class="text-center">Daftar Mahasiswa yang Mengikuti PKL</p>
                        </strong></div>
