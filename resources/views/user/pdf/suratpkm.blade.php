...
<body>
    ...
    @if (count($array_namamhs) != count($array_nimmhs))
        <h2 class="kementrian">Perika input nim dan namanya</h2>
                ...
                <div class="content">
                    <div id="alamat" class="row">
                        <div id="lampiran" class="col-md-6">
                            ...
                            @endif
                            Lampiran : - <br />
                            Perihal : Permohonan Surat Pengantar PKM
                            <br>
                            <br>
                        </div>
                        <div id="tgl-srt">
                    ...
                    <br>
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat pengantar Praktik Kegiatan Mengajar (PKM) bagi mahasiswa Program Studi {{$cekdata->prodi_mahasiswa}}
                        di
                        bawah ini: </div>
                        ...
                        <table class="table table-bordered border-dark">
                            ...
                            @for ($i = 0; $i < count($array_namamhs); $i++)
                                <tr>
                                    ...
                                    @if ($i == 0)
                                        <td rowspan="{{ $rowmerge }}">{{ $cekdata->formulir1 }}</td>
                                        <td rowspan="{{ $rowmerge }}">{{ $cekdata->formulir2 }}</td>
                                    @endif
                                </tr>
                            @endfor
                    ...
                    <br>
                    <div id="penutup">Berkenaan dengan hal tersebut kami mohon Bapak/Ibu berkenan memberikan surat
                        pengantar bagi mahasiswa tersebut untuk melakukan kegiatan Praktik Kegiatan Mengajar (PKM).
                    </div>
                    <br>
                    <div id="penutup">Demikian permohonan ini kami sampaikan. Atas bantuan dan kerjasa manya, kami
                        ucapkan
                        terima
                        kasih.</div>
                    <br>
        ...
        @if (is_array($array_namamhs) && count($array_namamhs) >= 4 && is_array($array_nimmhs) && count($array_nimmhs) >= 4)
            ...
            <div class="sheet">
                ...
                <div class="content">
                    ...
                    <div id="pembuka">Dengan hormat,</div>
                    <br>
                    <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan surat pengantar Praktik Kegiatan Mengajar (PKM) bagi mahasiswa Program Studi {{$cekdata->prodi_mahasiswa}} dengan daftar nama terlampir.</div>
                    <div id="tempat-tgl">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="tengah">
                                ...
                                <b class="kampus">
                                    Telepon (021) 4894909, E-mail : <a href="">dekanfmipa@unj.ac.id</a>, <a
                                        href="">www.fmipa.unj.ac.id</a>
                                </b>
                                <br>
                            </td>
                        </tr>
