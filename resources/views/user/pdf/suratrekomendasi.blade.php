        ...
        @if (is_array($array_namamhs) && count($array_namamhs) < 4 && is_array($array_nimmhs) && count($array_nimmhs) < 4)
            <div class="sheet">
                ...
                <div class="content">
                    ...
                    <div id="pembuka" class="row">Kami sampaikan Permohonan Rekomendasi untuk Mahasiswa Program Studi {{ $cekdata->prodi_mahasiswa }} FMIPA Universitas Negeri Jakarta yang tersebut di bawah
                        ini:
                    </div>
                    ...
                    <br>
                    <div id="penutup">Sebagai wakil mahasiswa dari Program Studi {{ $cekdata->prodi_mahasiswa }}
                        FMIPA Universitas Negeri
                        Jakarta, untuk {{ $cekdata->formulir1 }}.</div>
                    <br>
                ...
                <div class="content">
                    <div id="alamat" class="row">
                        <div id="lampiran" class="col-md-6">
                            ...
                            @endif
                            Lampiran : 1 <br />
                            Perihal : Surat Permohonan Rekomendasi
                            <br>
                            <br>
                        </div>
                        <div id="tgl-srt">
                    ...
                    <div id="pembuka" class="row">Dengan ini kami sampaikan Permohonan Rekomndasi untuk Mahasiswa Program Studi {{$cekdata->prodi_mahasiswa}} FMIPA Universitas Negeri Jakarta  dengan daftar nama terlampir.
                    </div>
                    <br>
                    <div id="penutup">Sebagai wakil mahasiswa dari Program Studi {{ $cekdata->prodi_mahasiswa }}
                        FMIPA Universitas Negeri
