            ...
            <div class="content">
                <div id="alamat" class="row">
                    <div id="lampiran" class="col-md-6">
                        <br>
                        <p id="tls">Jakarta, {{ $cekdata->updated_at->locale('id')->isoFormat('LL') }}</p>
                        ...
                        @endif
                        Lampiran : - <br />
                        Perihal : Surat Permohonan Transkrip Nilai
                        <br>
                        <br>
                    </div>
                    <div id="tgl-srt">
                ...
                <br>
                <div id="pembuka" class="row">Kami mengajukan permohonan untuk mendapatkan Transkrip Nilai guna keperluan  {{$cekdata->formulir3}} mahasiswa yang tersebut di bawah ini:</div>
                <br>
                <div id="tempat-tgl">
                ...
                <br>
                <div id="penutup">Demikian permohonan ini kami sampaikan. Atas bantuan dan kerja samanya, kami ucapkan
                    terima
                    kasih.</div>
                <br>
                <br>
